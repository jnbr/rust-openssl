...
#if LIBRESSL_VERSION_NUMBER >= 0x20900000
RUST_LIBRESSL_NEW
#elif LIBRESSL_VERSION_NUMBER >= 0x20800000
RUST_LIBRESSL_28X
...
"
    ...
    if expanded.contains("RUST_LIBRESSL_250") {
        ...
        println!("cargo:version=101");
        Version::Libressl
    } else if expanded.contains("RUST_LIBRESSL_28X") {
        println!("cargo:rustc-cfg=libressl");
        println!("cargo:rustc-cfg=libressl28");
        println!("cargo:libressl=true");
        println!("cargo:libressl_version=28x");
        println!("cargo:version=101");
        Version::Libressl
